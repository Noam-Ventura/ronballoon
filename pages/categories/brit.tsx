...
type BritPageProps = { images: string[] };

export default function BritPage({ images }: BritPageProps) {
  return (
    <Layout>
      <SEO title="ברית" />
      <section className="container py-8 sm:py-12 px-4 sm:px-6 grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
        ...
        <Reveal>
          <div className="text-center md:text-right">
            <h1 className="mb-4 text-2xl sm:text-3xl lg:text-4xl">ברית</h1>
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg">עיצובים רכים ומרגשים ליום מיוחד ומלא אהבה.</p>
          </div>
        </Reveal>
      </section>
